        ...
        <div class="row">
            <div class="col-lg-3 col-md-7 offset-md-1 offset-lg-0 mb-4 mb-lg-0">
                ...
                <div class="block about">
                    ...
                    <!-- description -->
                    <p class="alt-color">Inventaris Kantor di dalam ilmu akuntansi ialah segala bentuk kegiatan maupun
                        usaha untuk memperoleh data yang diperlukan mengenai persediaan barang yang dikelola ataupun
                        dimilikinya.</p>
                </div>
            </div>
            <!-- Link list -->
                ...
                <div class="copyright">
                    <p>Copyright &copy; <script>
                        ...
                        document.write(CurrentYear)
                            ...
                            href="https://instagram.com/ratuufaradiiba" target="_blank">Ratu
                            Faradiba Al Isra Syam</a></p>
                </div>
            </div>
            <div class="col-lg-6">
                <!-- Social Icons -->
                <ul class="social-media-icons text-center text-lg-right">
                    <li><a class="fa fa-facebook" href="https://www.facebook.com/faradibaalisra"></a></li>
                    <li><a class="fa fa-github-alt" href="https://www.github.com/ratuufaradiiba"></a></li>
                </ul>
            </div>
        </div>
    </div>
